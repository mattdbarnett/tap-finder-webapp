{
	...
	"EventDashBoard_SummaryStats_Desc": "(Бета) Това са импресиите и прочитите за събития и анонси от уникални вписани потребители. Това е само за нови събития и анонси, създадени с този редактор.",
	"EventDashBoard_SummaryStats_Link": "Кликнете тук за още подробности.",
	"EventDashBoard_Summary_LibraryHome_Shown": "Импресии от началната страница на библиотеката:",
	"EventDashBoard_Summary_LibraryHome_Read": "Прочити от началната страница на библиотеката:",
	"EventDashBoard_Summary_AppDetailSpotlight_Shown": "Импресии от детайлна страница за приложение в библиотеката:",
	"EventDashBoard_Summary_AppDetailSpotlight_Read": "Прочити от детайлна страница за приложение в библиотеката:",
	"EventDashBoard_Summary_AppDetailActivity_Shown": "Импресии от емисията за активност на детайлна страница за приложение в библиотеката:",
	"EventDashBoard_Summary_AppDetailActivity_Read": "Прочити от емисията за активност на детайлна страница за приложение в библиотеката:",
	"EventDashBoard_Summary_StoreAppPage_Shown": "Импресии от продуктовата страница в магазина:",
	"EventDashBoard_Summary_StoreAppPage_Read": "Прочити от продуктовата страница в магазина:",
	"EventDashBoard_Summary_Community_Shown": "Импресии от Steam общността:",
	"EventDashBoard_Summary_Community_Read": "Прочити от Steam общността:",
	...
	"PartnerEvent_11": "Предаване на живо",
	...
	"Sale_HiddenItems": "%1$s артикул(а) е(са) скрит(и) поради %2$s",
